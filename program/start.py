        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "𝙨𝙤𝙪𝙧𝙘𝙚 𝙩𝙞𝙩𝙤", url=f"https://t.me/{UPDATES_CHANNEL}"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "بحبك", url="https://t.me/LXX_CI"
                    )
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("بحبك", url=f"https://t.me/LXX_CI"),
                InlineKeyboardButton(
                    "𝙨𝙤𝙪𝙧𝙘𝙚 𝙩𝙞𝙩𝙤", url=f"https://t.me/LXX_CI"
                ),
            ]
        ]
    )
